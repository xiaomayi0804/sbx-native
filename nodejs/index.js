...
const ARGO_DOMAIN    = process.env.ARGO_DOMAIN    || 'codered.xiaomayi.nyc.mn';         // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH      = process.env.ARGO_AUTH      || 'eyJhIjoiODk1YzUyNmZlOGU0NzhhM2NlZjVmZDZlMzI5YmEwNjUiLCJ0IjoiZWU5ZjM2MTctYWI4MS00MzcyLTkwY2UtYTE0N2FjNjRhYWJiIiwicyI6Ik56Qm1PVGhrWkRjdE5HUmtPQzAwTURRM0xXRXpNV1F0Tm1Jd05tUTBOMk5sWVRFeSJ9';         // argo固定隧道token或json,留空即使用临时隧道
