...
const UUID           = process.env.UUID           || '92fcce24-626b-4384-a49a-9c3cc32af916'; // UUID，运行哪吒请修改
...
const ARGO_DOMAIN    = process.env.ARGO_DOMAIN    || 'host.xiaomayi.nyc.mn';         // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH      = process.env.ARGO_AUTH      || 'eyJhIjoiODk1YzUyNmZlOGU0NzhhM2NlZjVmZDZlMzI5YmEwNjUiLCJ0IjoiZDdmOTBhNzItNjFmMS00N2MzLTg4MWItMTRjZTZkZTg0OWZkIiwicyI6Ik56STFZekE0TkRRdFptUXdaUzAwWVRKaExUZzNZMk10TTJaaE56QmhZbVV3TVdGaiJ9';         // argo固定隧道token或json,留空即使用临时隧道
...
const HY2_PORT       = process.env.HY2_PORT       || '25368';         // hy2端口，留空不启用
